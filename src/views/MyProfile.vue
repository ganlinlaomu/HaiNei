...
<style scoped>
.profile-page{width:100%;max-width:none;margin:0;box-sizing:border-box;padding:8px 14px calc(var(--bottom-nav-height) + env(safe-area-inset-bottom) + 24px)}
...
@media (min-width:720px){.profile-editor{max-width:560px;margin:0 auto}}
</style>
